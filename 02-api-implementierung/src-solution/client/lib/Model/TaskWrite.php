 ...
 * @link     https://openapi-generator.tech
 */
class TaskWrite implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'TaskWrite';
    ...
    public function setText($text)
    {
        if ((mb_strlen($text) > 255)) {
            throw new \InvalidArgumentException('invalid length for $text when calling TaskWrite., must be smaller than or equal to 255.');
        }
        if ((mb_strlen($text) < 2)) {
            throw new \InvalidArgumentException('invalid length for $text when calling TaskWrite., must be bigger than or equal to 2.');
        }
